...
ruta_html = r"c:\Users\deiker.aguilera\Desktop\WorkSpace\Respaldos SGD_Temporal\Respaldo 301_Narcisa Barzola_Analista_Rectorado\documentos\enviados.html"
carpeta_documentos = os.path.abspath(os.path.join(os.path.dirname(ruta_html), "..", "documentos"))
carpeta_destino = r"c:\Users\deiker.aguilera\Desktop\WorkSpace\Respaldos SGD_Temporal\Respaldo 301_Narcisa Barzola_Analista_Rectorado\Doc. Enviados"
...
with ExcelWriter(excel_path, engine="xlsxwriter", engine_kwargs={"options": {"strings_to_urls": False}}) as writer:
    df.to_excel(writer, index=False, sheet_name="Doc._Enviados") # Nombre de la hoja Excel
